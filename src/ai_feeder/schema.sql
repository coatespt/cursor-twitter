...
-- Extends the existing pipeline schema with AI analysis capabilities
...
CREATE INDEX idx_ai_sessions_run_id ON ai_analysis_sessions(run_id);
...
CREATE INDEX idx_ai_results_cluster_id ON ai_analysis_results(cluster_id);
CREATE INDEX idx_ai_insights_result_id ON ai_insights(result_id);
