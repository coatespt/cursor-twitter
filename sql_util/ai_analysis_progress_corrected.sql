-- Corrected AI Analysis Progress Report for sept_4_ptc run
...
WITH run_stats AS (
    SELECT 
        er.run_id,
        er.run_name,
        COUNT(DISTINCT CASE WHEN aar.result_id IS NOT NULL THEN b.batch_number END) as batches_with_ai,
        COUNT(DISTINCT CASE WHEN aar.result_id IS NOT NULL THEN c.id END) as clusters_with_ai,
